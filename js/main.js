// Enhanced Ugarit Website JavaScript with Luxury Animations

document.addEventListener('DOMContentLoaded', function() {
    console.log('Ugarit website initializing with luxury animations...');
    ...
    // Luxury animations
    initLuxuryPageTransitions();
    initLuxuryTabInteractions();
...
function initLuxuryPageTransitions() {
    ...
    links.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            if (href && !href.startsWith('#') && !href.startsWith('http') &&
                ...
                document.body.style.transition = 'opacity 0.6s cubic-bezier(0.23, 1, 0.32, 1)';
...
// Luxury Tab Interactions
function initLuxuryTabInteractions() {
...
window.addEventListener('load', () => {
    console.log('Ugarit website fully loaded with luxury animations');
